...
(*destruct Boolblbl with (n:=n)(b:= TRue)(n1:= n5)(b1:= if_then_else_B (Bvar n) (Bvar n1) (Bvar n2)) (b2:=b1).
rewrite e. *)
...
Theorem Ex9msg_bol2: forall (b b1 b2: Bool )( n1 n2 n3 n4 n5 n6 :nat),   (if_then_else_B b ([n5:= (if_then_else_B b (Bvar n1) (Bvar n2))] b1) ([n6:=  (if_then_else_B b (Bvar n3) (Bvar n4))] b2))
                      ##  ( if_then_else_B b ([n5:= (Bvar n1)] b1)                                     ([n6:= (Bvar n4)] b2) ) .
