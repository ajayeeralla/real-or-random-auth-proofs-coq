...
Definition qa00 :=   (ifm ((eqm (to x1) (i 1)) & (eqm (act x1) new)) (grn 1) (ifm (eqm (to x1) (i 2)) (pair (grn 2) (sign (sk 4)  (pair (grn 2) x1))) O)).
...
Definition qa10 :=  (ifm ((eqm (to x2) (i 1))& (ver (pk 4) (pair (pi1 (x2))  (grn 1))   (pi2 (x2)))) (sign (sk 3) (pair  (grn 1) (pi1 (x2))))  O ).
Definition qa01:=  (ifm (eqm (to x2) (i 2))& (ver (pk 3) (pair (grn 1) (pi1 x2)) x2) acc O) .
Definition qa00_s :=  (ifm ((eqm (to x1) (i 1)) & (eqm (act x1) new)) qa10 (ifm (eqm (to x1) (i 2)) qa01 O)).
...
Definition qa20 :=  (ifm (eqm (reveal x3) (i 2))& (notb (eqm (pi1(x2)) (grn 1)) & (eqm x1 (grn 1)))  O O ).
Definition qa02 := (ifm (eqm (reveal x3) (i 2))& (notb ((eqm (pi1(x2)) (grn 1))) &  (eqm x1 (grn 1)))  O O ).
Definition qa10_s :=    (ifm ((eqm (to x2) (i 1))& (ver (pk 4) (pair (pi1 (x2))  (grn 1)) (pi2 x2)))  qa20 O ).
Definition qa01_s := (ifm (eqm (to x2) (i 2))& (ver (pk 3) (pair x1 (grn 1)) x2)& (eqm (pi1(x2)) (grn 1)) & (eqm x1 (grn 1)) qa02 O).
Definition qa00_ss :=  (ifm ((eqm (to x1) (i 1)) & (eqm (act x1) new)) qa10_s (ifm (eqm (to x1) (i 2)) qa01_s O)).
...
Definition qb20 :=  (ifm (eqm (reveal x3) (i 2))& (notb (eqm (pi1(x2)) (grn 1)) & (eqm x1 (grn 1)))  O O ).

Definition qb02 := (ifm (eqm (reveal x3) (i 2))& (notb (eqm (pi1(x2)) (grn 1)) & (eqm x1 (grn 1))) new O ).

Definition qb10_s :=    (ifm ((eqm (to x2) (i 1))& (ver (pk 4) (pair (pi1 (x2))  (grn 1)) (pi2 x2)))  qb20 O ).

Definition qb01_s := (ifm (eqm (to x2) (i 2))& (ver (pk 3) (pair x1 (grn 1)) x2)& (eqm (pi1(x2)) (grn 1)) & (eqm x1 (grn 1)) qb02 O).

Definition qb00_ss :=  (ifm ((eqm (to x1) (i 1)) & (eqm (act x1) new)) qb10_s (ifm (eqm (to x1) (i 2)) qb01_s O)).
...
assert(trm3: (ifm (eqm (to x1) (i 1)) & (eqm (act x1) new)
         (ifm
            (eqm (to x2) (i 1)) & (ver (pk 4) (pair (pi1 x2) (grn 1)) (pi2 x2))
            (ifm
               (eqm (reveal x3) (i 2)) &
               (notb (eqm (pi1 x2) (grn 1)) & (eqm x1 (grn 1))) O O) O)
         (ifm (eqm (to x1) (i 2))
            (ifm
               (((eqm (to x2) (i 2)) & (ver (pk 3) (pair x1 (grn 1)) x2)) &
                (eqm (pi1 x2) (grn 1))) & (eqm x1 (grn 1))
               (ifm
                  (eqm (reveal x3) (i 2)) &
                  (notb (eqm (pi1 x2) (grn 1)) & (eqm x1 (grn 1))) O O) O) O)) # (ifm (eqm (to x1) (i 1)) & (eqm (act x1) new)
         (ifm
            (eqm (to x2) (i 1)) & (ver (pk 4) (pair (pi1 x2) (grn 1)) (pi2 x2))
            (ifm
               (eqm (reveal x3) (i 2)) &
...
assert(pf:  (((eqm (to x2) (i 2)) & (FAlse)) & (eqm (pi1 x2) (grn 1))) &
            (eqm x1 (grn 1)) ## FAlse).
rewrite andB_FAlse_r with (b:= (eqm (to x2) (i 2))).
rewrite andB_FAlse_l with (b:= (eqm (pi1 x2) (grn 1))).
rewrite andB_FAlse_l with (b:= (eqm x1 (grn 1))). reflexivity.
rewrite pf.
