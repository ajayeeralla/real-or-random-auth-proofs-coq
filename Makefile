...
.PHONY: all opt byte archclean clean install userinstall depend html validate ./coqc
...
install:
	...
	(cd ./coqc; $(MAKE) DSTROOT=$(DSTROOT) INSTALLDEFAULTROOT=$(INSTALLDEFAULTROOT)/./coqc install)
